...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CommunityForumParticipant'
        db.create_table('community_forum_communityforumparticipant', (
            ('person_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.Person'], unique=True, primary_key=True)),
            ('webex_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
        ))
        db.send_create_signal('community_forum', ['CommunityForumParticipant'])

        # Adding model 'CommunityForumParticipantVersion'
        db.create_table('community_forum_communityforumparticipantversion', (
            ('personversion_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.PersonVersion'], unique=True, primary_key=True)),
            ('webex_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
        ))
        db.send_create_signal('community_forum', ['CommunityForumParticipantVersion'])


    def backwards(self, orm):
        
        # Deleting model 'CommunityForumParticipant'
        db.delete_table('community_forum_communityforumparticipant')

        # Deleting model 'CommunityForumParticipantVersion'
        db.delete_table('community_forum_communityforumparticipantversion')
