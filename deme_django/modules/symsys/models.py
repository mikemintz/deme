...
class SymsysAffiliate(Person):
    ...
    relevant_global_abilities = frozenset(['create SymsysAffiliate'])
...
class Event(HtmlDocument):
    ...
    relevant_global_abilities = frozenset(['create Event'])
...
class TextAdvertisement(TextDocument, Advertisement):
    ...
    relevant_global_abilities = frozenset(['create TextAdvertisement'])
...
class HtmlAdvertisement(HtmlDocument, Advertisement):
    ...
    relevant_global_abilities = frozenset(['create HtmlAdvertisement'])
