...
class SymsysAffiliate(Person):
    ...
    bs_graduation_year = models.PositiveIntegerField(null=True, blank=True, default=None)
    ms_graduation_year = models.PositiveIntegerField(null=True, blank=True, default=None)
    ...
    admin_title = models.CharField(max_length=255, blank=True, choices=[("Advising Fellow", "Advising Fellow"), ("Associate Director", "Associate Director"), ("Director Emeritus", "Director Emeritus"), ("Graduate Studies Director", "Graduate Studies Director"), ("Program Director", "Program Director"), ("Student Services Officer", "Student Services Officer"), ("Webmaster", "Webmaster")])

    bs_advisor = models.ForeignKey('SymsysAffiliate', null=True, blank=True, related_name="bs_advisor_group", default=None)
    honors_advisor = models.ForeignKey('SymsysAffiliate', null=True, blank=True, related_name="honors_advisor_group", default=None)
    ms_advisor = models.ForeignKey('SymsysAffiliate', null=True, blank=True, related_name="ms_advisor_group", default=None)
    honors_second_reader = models.ForeignKey('SymsysAffiliate', null=True, blank=True, related_name="honors_second_reader_group", default=None)
    ms_second_reader = models.ForeignKey('SymsysAffiliate', null=True, blank=True, related_name="ms_second_reader_group", default=None)
