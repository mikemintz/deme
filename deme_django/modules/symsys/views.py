...
class SymsysAffiliateViewer(ItemViewer):
    ...
    def entry_show(self):
        ...
        visible_memberships = Membership.objects.filter(permissions.filter_items_by_permission(self.cur_agent, 'view itemset'), permissions.filter_items_by_permission(self.cur_agent, 'view item'))
