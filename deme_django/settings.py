...
DATABASE_OPTIONS = {"init_command": "SET storage_engine=INNODB"} # so we get foreign-key and transactions
...
SECRET_KEY = 'kk3vbdl!x=jifip9dby3bwj-frcwcfc=8#=ibm%)bwwr4%yy+a'
