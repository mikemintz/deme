...
class OpenidAccountViewer(AuthenticationMethodViewer):
    ...
    def type_login_html(self):
        ...
        full_redirect = self.request.build_absolute_uri('%s?redirect=%s' % (reverse('item_type_url', kwargs={'viewer': self.viewer_name, 'action': 'logincomplete'}), urlquote(redirect)))
