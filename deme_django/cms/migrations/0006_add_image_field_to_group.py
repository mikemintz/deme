...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupVersion.image'
        db.add_column('cms_groupversion', 'image', self.gf('django.db.models.ForeignKey')(related_name='version_groups_with_image', default=None, to=orm['cms.ImageDocument'], blank=True, null=True, db_index=False), keep_default=False)

        # Adding field 'Group.image'
        db.add_column('cms_group', 'image', self.gf('django.db.models.ForeignKey')(default=None, related_name='groups_with_image', null=True, blank=True, to=orm['cms.ImageDocument']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'GroupVersion.image'
        db.delete_column('cms_groupversion', 'image_id')

        # Deleting field 'Group.image'
        db.delete_column('cms_group', 'image_id')
