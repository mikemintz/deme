...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteVersion.logo'
        db.add_column('cms_siteversion', 'logo',
                      self.gf('django.db.models.ForeignKey')(related_name='version_sites_with_logo', default=None, to=orm['cms.ImageDocument'], blank=True, null=True, db_index=False),
                      keep_default=False)

        # Adding field 'SiteVersion.title'
        db.add_column('cms_siteversion', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Site.logo'
        db.add_column('cms_site', 'logo',
                      self.gf('django.db.models.ForeignKey')(default=None, related_name='sites_with_logo', null=True, blank=True, to=orm['cms.ImageDocument']),
                      keep_default=False)

        # Adding field 'Site.title'
        db.add_column('cms_site', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteVersion.logo'
        db.delete_column('cms_siteversion', 'logo_id')

        # Deleting field 'SiteVersion.title'
        db.delete_column('cms_siteversion', 'title')

        # Deleting field 'Site.logo'
        db.delete_column('cms_site', 'logo_id')

        # Deleting field 'Site.title'
        db.delete_column('cms_site', 'title')
    ...
    models = {
        ...
        'cms.site': {
            ...
            'logo': ('django.db.models.ForeignKey', [], {'default': 'None', 'related_name': "'sites_with_logo'", 'null': 'True', 'blank': 'True', 'to': "orm['cms.ImageDocument']"}),
        ...
        'cms.siteversion': {
            ...
            'logo': ('django.db.models.ForeignKey', [], {'related_name': "'version_sites_with_logo'", 'default': 'None', 'to': "orm['cms.ImageDocument']", 'blank': 'True', 'null': 'True', 'db_index': 'False'}),
            'title': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'viewerrequestversion_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.ViewerRequestVersion']", 'unique': 'True', 'primary_key': 'True'})
        },
