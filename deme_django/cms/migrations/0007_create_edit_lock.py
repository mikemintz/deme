...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cms_editlock', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='edit_locks', unique=True, to=orm['cms.Item'])),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='edit_locks_as_editor', to=orm['cms.Agent'])),
            ('lock_acquire_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('lock_refresh_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('cms', ['EditLock'])


    def backwards(self, orm):
        
        # Deleting model 'EditLock'
        db.delete_table('cms_editlock')
