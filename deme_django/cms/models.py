...
class Item(models.Model):
    ...
    * introduced_global_abilities: a frozenset of global abilities that are
    ...
    def deactivate(self, action_agent, action_summary=None, action_time=None):
        ...
        DeactivateActionNotice(item=self, item_version_number=self.version_number, creator=action_agent, action_time=action_time, action_summary=action_summary).save()
        old_item = self
        new_item = None
    ...
    def reactivate(self, action_agent, action_summary=None, action_time=None):
        ...
        # Create relevant ActionNotices
        ReactivateActionNotice(item=self, item_version_number=self.version_number, creator=action_agent, action_time=action_time, action_summary=action_summary).save()
        old_item = None
        new_item = self
    ...
    def destroy(self, action_agent, action_summary=None, action_time=None):
        ...
        # Create relevant ActionNotices
        DestroyActionNotice(item=self, item_version_number=self.version_number, creator=action_agent, action_time=action_time, action_summary=action_summary).save()
    ...
    def save_versioned(self, action_agent, action_summary=None, action_time=None, first_agent=False, initial_permissions=None):
        ...
        # Create relevant ActionNotices
        if is_new:
            CreateActionNotice(item=self, item_version_number=self.version_number, creator=action_agent, action_time=action_time, action_summary=action_summary).save()
            if self.active:
                RelationActionNotice.create_notices(action_agent, action_summary, action_time, item=self, existed_before=False, existed_after=True)
        else:
            EditActionNotice(item=self, item_version_number=self.version_number, creator=action_agent, action_time=action_time, action_summary=action_summary).save()
            if self.active:
