...
WebauthAuthenticationMethod(username="davies", agent=todd_person).save_versioned(action_agent=todd_person)
...
joe_person = Person(first_name="Joe", last_name="Marrama", name="Joe Marrama")
joe_person.save_versioned(action_agent=admin)
AgentItemPermission(agent=joe_person, item=joe_person, ability='do_anything', is_allowed=True).save()
joe_authentication_method = PasswordAuthenticationMethod(username="joe", agent=joe_person)
joe_authentication_method.set_password('')
joe_authentication_method.save_versioned(action_agent=joe_person)
WebauthAuthenticationMethod(username="jmarrama", agent=joe_person).save_versioned(action_agent=joe_person)
joe_email_contact_method = EmailContactMethod(name="Joe's Email Contact Method", email="joe@example.com", agent=joe_person)
joe_email_contact_method.save_versioned(action_agent=joe_person)
...
Membership(item=joe_person, collection=discuss_group).save_versioned(action_agent=admin)
...
Subscription(contact_method=joe_email_contact_method, item=discuss_group.folios.get(), deep=True).save_versioned(action_agent=joe_person)
